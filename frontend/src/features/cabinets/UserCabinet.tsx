            ...
            <Grid item xs={12} sm={6} md={3}>
              ...
              >
                <ListItemButton onClick={handleClickMyInfo}>
                  ...
                  <ListItemText style={state.myInfo ? { color: '#03C988' } : {}} primary={'myInfo'} />
                </ListItemButton>
                <ListItemButton onClick={handleClickOrders}>
                  <ListItemIcon>
                    <MapsHomeWorkIcon style={state.orders ? { color: '#03C988' } : {}} />
                  </ListItemIcon>
                  <ListItemText style={state.orders ? { color: '#03C988' } : {}} primary={'myOrders'} />
                </ListItemButton>
                <ListItemButton onClick={handleClickFavorites}>
                  <ListItemIcon>
                    <FavoriteIcon style={state.favorites ? { color: '#03C988' } : {}} />
                  </ListItemIcon>
                  <ListItemText style={state.favorites ? { color: '#03C988' } : {}} primary={'myFavorites'} />
                </ListItemButton>
              </List>
            </Grid>
            <Grid item xs>
